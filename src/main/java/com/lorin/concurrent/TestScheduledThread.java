...
public class TestScheduledThread {
    ...
    public static void main(String[] args) {
        ...
        final ScheduledExecutorService scheduler1 = Executors.newScheduledThreadPool(2);
        ...
        final ScheduledFuture beeperHandle1 = scheduler1.scheduleAtFixedRate(beeper, 1, 2, TimeUnit.SECONDS);
        // 2秒钟后运行，并每次在上次任务运行完后等待5秒后重新运行
        final ScheduledFuture beeperHandle2 = scheduler.scheduleWithFixedDelay(beeper, 2, 5, TimeUnit.SECONDS);
        final ScheduledFuture beeperHandle3 = scheduler1.scheduleWithFixedDelay(beeper, 2, 5, TimeUnit.SECONDS);
