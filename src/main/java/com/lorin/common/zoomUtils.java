...
public class zoomUtils {
    ...
    public static boolean zoomOutImage(String srcPath,String newPath,Integer times){
        BufferedImage bufferedImage = null;
        try {
            URL tranUrl = new URL(srcPath);
            bufferedImage =  ImageIO.read(tranUrl);
        } catch (IOException e) {
            //TODO: 打印日志
            return false;
        }
...
//        }
        boolean testOut = zoomOutImage("http://img.v19.56.com/images/13/8/iccidd13i56olo56i56.com_133609916086hd.jpg?j=60839","D:\\out.jpg",2);
        if(testOut){
